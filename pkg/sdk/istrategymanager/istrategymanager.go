...
func (_Contract *ContractTransactor) AddShares(opts *bind.TransactOpts, staker common.Address, strategy common.Address, shares *big.Int) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "addShares", staker, strategy, shares)
}

func (_Contract *ContractSession) AddShares(staker common.Address, strategy common.Address, shares *big.Int) (*types.Transaction, error) {
	return _Contract.Contract.AddShares(&_Contract.TransactOpts, staker, strategy, shares)
}

func (_Contract *ContractTransactorSession) AddShares(staker common.Address, strategy common.Address, shares *big.Int) (*types.Transaction, error) {
	return _Contract.Contract.AddShares(&_Contract.TransactOpts, staker, strategy, shares)
}

func (_Contract *ContractTransactor) AddStrategiesToDepositWhitelist(opts *bind.TransactOpts, strategiesToWhitelist []common.Address) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "addStrategiesToDepositWhitelist", strategiesToWhitelist)
}

func (_Contract *ContractSession) AddStrategiesToDepositWhitelist(strategiesToWhitelist []common.Address) (*types.Transaction, error) {
	return _Contract.Contract.AddStrategiesToDepositWhitelist(&_Contract.TransactOpts, strategiesToWhitelist)
}

func (_Contract *ContractTransactorSession) AddStrategiesToDepositWhitelist(strategiesToWhitelist []common.Address) (*types.Transaction, error) {
	return _Contract.Contract.AddStrategiesToDepositWhitelist(&_Contract.TransactOpts, strategiesToWhitelist)
}
