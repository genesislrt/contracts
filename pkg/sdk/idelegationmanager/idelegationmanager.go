...
func (_Contract *ContractCaller) StakeRegistry(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "stakeRegistry")
...
func (_Contract *ContractSession) StakeRegistry() (common.Address, error) {
	return _Contract.Contract.StakeRegistry(&_Contract.CallOpts)
}

func (_Contract *ContractCallerSession) StakeRegistry() (common.Address, error) {
	return _Contract.Contract.StakeRegistry(&_Contract.CallOpts)
}
...
type ContractStakeRegistrySetIterator struct {
	Event *ContractStakeRegistrySet
...
func (it *ContractStakeRegistrySetIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ContractStakeRegistrySet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (it *ContractStakeRegistrySetIterator) Error() error {
	return it.fail
}

func (it *ContractStakeRegistrySetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

type ContractStakeRegistrySet struct {
	StakeRegistry common.Address
	Raw           types.Log
}

func (_Contract *ContractFilterer) FilterStakeRegistrySet(opts *bind.FilterOpts) (*ContractStakeRegistrySetIterator, error) {

	logs, sub, err := _Contract.contract.FilterLogs(opts, "StakeRegistrySet")
	if err != nil {
		return nil, err
	}
	return &ContractStakeRegistrySetIterator{contract: _Contract.contract, event: "StakeRegistrySet", logs: logs, sub: sub}, nil
}

func (_Contract *ContractFilterer) WatchStakeRegistrySet(opts *bind.WatchOpts, sink chan<- *ContractStakeRegistrySet) (event.Subscription, error) {

	logs, sub, err := _Contract.contract.WatchLogs(opts, "StakeRegistrySet")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ContractStakeRegistrySet)
				if err := _Contract.contract.UnpackLog(event, "StakeRegistrySet", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_Contract *ContractFilterer) ParseStakeRegistrySet(log types.Log) (*ContractStakeRegistrySet, error) {
	event := new(ContractStakeRegistrySet)
	if err := _Contract.contract.UnpackLog(event, "StakeRegistrySet", log); err != nil {
		return nil, err
	}
...
type ContractWithdrawalDelayBlocksSetIterator struct {
	Event *ContractWithdrawalDelayBlocksSet
...
func (it *ContractWithdrawalDelayBlocksSetIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ContractWithdrawalDelayBlocksSet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (it *ContractWithdrawalDelayBlocksSetIterator) Error() error {
	return it.fail
}

func (it *ContractWithdrawalDelayBlocksSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

type ContractWithdrawalDelayBlocksSet struct {
	PreviousValue *big.Int
	NewValue      *big.Int
	Raw           types.Log
}

func (_Contract *ContractFilterer) FilterWithdrawalDelayBlocksSet(opts *bind.FilterOpts) (*ContractWithdrawalDelayBlocksSetIterator, error) {

	logs, sub, err := _Contract.contract.FilterLogs(opts, "WithdrawalDelayBlocksSet")
	if err != nil {
		return nil, err
	}
	return &ContractWithdrawalDelayBlocksSetIterator{contract: _Contract.contract, event: "WithdrawalDelayBlocksSet", logs: logs, sub: sub}, nil
}

func (_Contract *ContractFilterer) WatchWithdrawalDelayBlocksSet(opts *bind.WatchOpts, sink chan<- *ContractWithdrawalDelayBlocksSet) (event.Subscription, error) {

	logs, sub, err := _Contract.contract.WatchLogs(opts, "WithdrawalDelayBlocksSet")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ContractWithdrawalDelayBlocksSet)
				if err := _Contract.contract.UnpackLog(event, "WithdrawalDelayBlocksSet", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_Contract *ContractFilterer) ParseWithdrawalDelayBlocksSet(log types.Log) (*ContractWithdrawalDelayBlocksSet, error) {
	event := new(ContractWithdrawalDelayBlocksSet)
	if err := _Contract.contract.UnpackLog(event, "WithdrawalDelayBlocksSet", log); err != nil {
		return nil, err
	}
...
func (_Contract *Contract) ParseLog(log types.Log) (generated.AbigenLog, error) {
	...
	case _Contract.abi.Events["StakeRegistrySet"].ID:
		return _Contract.ParseStakeRegistrySet(log)
	...
	case _Contract.abi.Events["WithdrawalDelayBlocksSet"].ID:
		return _Contract.ParseWithdrawalDelayBlocksSet(log)
...
func (ContractStakeRegistrySet) Topic() common.Hash {
	return common.HexToHash("0xce6d874069bceda1867eca9c60636bbf262e15213041658273d803a2b609a51f")
}
...
func (ContractWithdrawalDelayBlocksSet) Topic() common.Hash {
	return common.HexToHash("0x4ffb00400574147429ee377a5633386321e66d45d8b14676014b5fa393e61e9e")
}
...
type ContractInterface interface {
	...
	FilterStakeRegistrySet(opts *bind.FilterOpts) (*ContractStakeRegistrySetIterator, error)

	WatchStakeRegistrySet(opts *bind.WatchOpts, sink chan<- *ContractStakeRegistrySet) (event.Subscription, error)

	ParseStakeRegistrySet(log types.Log) (*ContractStakeRegistrySet, error)
	...
	FilterWithdrawalDelayBlocksSet(opts *bind.FilterOpts) (*ContractWithdrawalDelayBlocksSetIterator, error)

	WatchWithdrawalDelayBlocksSet(opts *bind.WatchOpts, sink chan<- *ContractWithdrawalDelayBlocksSet) (event.Subscription, error)

	ParseWithdrawalDelayBlocksSet(log types.Log) (*ContractWithdrawalDelayBlocksSet, error)
